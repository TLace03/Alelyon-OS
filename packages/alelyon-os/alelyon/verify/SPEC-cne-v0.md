...
([PLATFORM.md](PLATFORM.md) §3 items 1–2). What the leaf does **not** do is make
...
capture. Per [CLAIMS.md](CLAIMS.md) §1 this is revision detection, not invention
...
This is [CLAIMS.md](CLAIMS.md) §2.3 — validating against the shape of what the
...
[CLAIMS.md](CLAIMS.md) §1 the shipped witness is co-located with the signer, so it
is not one today.
