...
> the first external verification (PLATFORM.md (internal) §5).
> **last-refereed:** 2026-07-29 · Bound by CLAIMS.md (internal); the do-not-say list
...
authoritative format was "whatever the Python does" (PLATFORM.md (internal)
...
the input data is true. Per CLAIMS.md (internal) rule 8, we certify arithmetic
...
> not carry. Recorded as PLATFORM.md (internal) §3 ledger item 4.
...
> **Naming discipline (CLAIMS.md (internal) §1).** This is a **co-signing
...
> says so (CLAIMS.md (internal) rule 1).
...
>
> This is §2 rule 3 of CLAIMS.md (internal) — validate against an
...
(PLATFORM.md (internal) Risks, item 2).
...
Until the PLATFORM.md (internal) §5 milestone passes, `alelyon.cne/v0` is a
...
Stated at exactly the verified strength, per CLAIMS.md (internal).
...
- **W1's acceptance test and the W8 milestone are unreachable as written unless
  ...
  `ok=false`. PLATFORM.md (internal) W1(b) says the Rust extension is
...
- **Anchoring proves matching, not maximality** (§5.5) — carried through from
  PLATFORM.md (internal) ledger item 4 into normative text, with an explicit
